...
class SpeedtestConfig {
    ...
    constructor(json: JSONObject) {
        try {
            ...
            if (json.has("dl_graceTime")) dl_graceTime = json.getInt("dl_graceTime").toDouble()
            if (json.has("ul_graceTime")) ul_graceTime = json.getInt("ul_graceTime").toDouble()
            ...
            if (json.has("errorHandlingMode")) errorHandlingMode = json["errorHandlingMode"].toString()
            ...
            if (json.has("telemetry_extra")) telemetry_extra = json["telemetry_extra"].toString()
            ...
            if (json.has("getIP_distance")) getIP_distance = json["getIP_distance"].toString()
            if (json.has("test_order")) test_order = json["test_order"].toString()
