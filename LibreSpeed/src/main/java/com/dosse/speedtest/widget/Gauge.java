package com.dosse.speedtest.widget;

import com.dosse.speedtest.widget.events.UpdateEventListener;
import com.dosse.speedtest.widget.skins.BarSkin;
import com.dosse.speedtest.widget.skins.GaugeSkin;
import com.dosse.speedtest.widget.events.UpdateEvent;
import com.dosse.speedtest.widget.events.UpdateEventListener;
import com.dosse.speedtest.widget.skins.*;
import com.dosse.speedtest.widget.tools.Data;
import com.dosse.speedtest.widget.tools.GradientLookup;
import com.dosse.speedtest.widget.tools.Helper;
import com.dosse.speedtest.widget.tools.MarkerComparator;
import com.dosse.speedtest.widget.tools.MovingAverage;
import com.dosse.speedtest.widget.tools.SectionComparator;
...
public class Gauge extends Control {
    ...
    @Override public String getUserAgentStylesheet() {
        if (null == userAgentStyleSheet) { userAgentStyleSheet = getClass().getResource("/styles/gauge.css").toExternalForm(); }
