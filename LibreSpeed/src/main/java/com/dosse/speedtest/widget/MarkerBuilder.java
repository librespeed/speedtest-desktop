...
import com.dosse.speedtest.widget.Marker.MarkerType;
...
public class MarkerBuilder<B extends MarkerBuilder<B>> {
    ...
    public final B markerType(final Marker.MarkerType TYPE) {
    ...
    public final Marker build() {
        ...
        for (String key : properties.keySet()) {
            if ("value".equals(key)) {
                ...
                MARKER.setMarkerType(((ObjectProperty<Marker.MarkerType>) properties.get(key)).get());
