package com.dosse.speedtest.core.worker
...
import com.dosse.speedtest.core.download.DownloadStream
import com.dosse.speedtest.core.getIP.GetIP
...
import com.dosse.speedtest.core.telemetry.Telemetry
import com.dosse.speedtest.core.upload.UploadStream
        ...
        private get() {
            ...
            val g: GetIP = object : GetIP(c!!, backend.getIpURL!!, config.getIP_isp, config.getGetIP_distance()) {
                override fun onDataReceived(data: String?) {
                    ...
                    ipIsp = data
                    try {
                        data = com.dosse.speedtest.widget.json.JSONObject(data)["processedString"] as String
                    } catch (t: Throwable) {
                    }
